...
describe('All intents', function() {
  ...
  describe('Test LaunchIntent', function() {
     ...
     it('valid outputSpeech', function() {
       expect(ctx.speechResponse.response.outputSpeech.ssml).to.match(/In the craziness of life/);
     });
    ...
    describe(`Test IdeaIntentName`, function() {

        before(function(done) {
          event.request.intent = {};
          event.session.attributes = {};
          event.request.type = 'IntentRequest';
          event.request.intent.name = 'IdeaIntent';
       ...
       it('valid outputSpeech', function() {
         expect(ctx.speechResponse.response.outputSpeech.ssml).to.match(/your idea for today/);
       });
